...
class StatusUpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create status_update" do
    assert_difference("StatusUpdate.count") do
      post status_updates_url, params: { status_update: { pharmacy_id: @status_update.pharmacy_id, prescription_id: @status_update.prescription_id, status: @status_update.status } }
    end
  ...
  test "should update status_update" do
    patch status_update_url(@status_update), params: { status_update: { pharmacy_id: @status_update.pharmacy_id, prescription_id: @status_update.prescription_id, status: @status_update.status } }
