...
class MedicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medication" do
    assert_difference("Medication.count") do
      post medications_url, params: { medication: { dosage: @medication.dosage, name: @medication.name, prescription_id: @medication.prescription_id, timing: @medication.timing } }
    end
  ...
  test "should update medication" do
    patch medication_url(@medication), params: { medication: { dosage: @medication.dosage, name: @medication.name, prescription_id: @medication.prescription_id, timing: @medication.timing } }
