...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference("Prescription.count") do
      post prescriptions_url, params: { prescription: { doctor_id: @prescription.doctor_id, expires_at: @prescription.expires_at, issued_at: @prescription.issued_at, patient_id: @prescription.patient_id, qr_token: @prescription.qr_token } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { doctor_id: @prescription.doctor_id, expires_at: @prescription.expires_at, issued_at: @prescription.issued_at, patient_id: @prescription.patient_id, qr_token: @prescription.qr_token } }
