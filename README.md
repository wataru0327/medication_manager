...
### 🔹①医者 薬を登録する
![薬の新規登録ページ](./docs/医者薬の新規登録.png)

### 🔹②医者 処方箋を作成する
![処方箋の新規作成ページ](./docs/医者処方箋の新規作成.png)

### 🔹③医者 処方箋のQRコードを作成する
![処方箋QRコードを作成ページ](./docs/医者新規作成処方箋のQRコード作成.png)

### 🔹④患者 処方箋のQRコードを読み込む
![患者処方箋QRコード読み取りページ](./docs/患者処方箋の受け取り.png)

### 🔹⑤患者 薬局に病院から受け取った処方箋を提出する
![患者処方箋QRコード提示ページ](./docs/患者処方箋QRコード薬局提出用.png)

### 🔹⑥薬局 患者が提示した処方箋QRコードを読み込む
![薬局処方箋QRコード読み取りページ](./docs/薬局処方箋QRコード受付.png)

### 🔹⑦薬局 調剤を開始する
![薬局調剤開始ボタン表示ページ](./docs/薬局調剤開始.png)

### 🔹⑧薬局 患者に薬を受け渡す
![薬局薬受け渡し完了ボタン表示ページ](./docs/薬局薬受け渡し.png)

### 🔹⑨患者 服薬のタイミングと残量がカレンダーに表示される
![お薬カレンダー表示ページ](./docs/患者服薬カレンダー.png)
